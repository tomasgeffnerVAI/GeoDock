...
if __name__ == '__main__':
    ...
    for mode in modes:
        ...
        filtered_df = df[(df['pinder_s']) & (df[f'{mode}_R']) & (df[f'{mode}_L']) ] #| (df['pinder_af2'] == True)]
    ...
    for files, dmodes in zip(pdb_paths, modes_decoy):
        ...
        try:
            ...
            with open("/home/celine/geodock_inference_240113/pinder_s/exception_log.txt", "a") as file:

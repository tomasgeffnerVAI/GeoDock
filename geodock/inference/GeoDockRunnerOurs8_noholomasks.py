...
def get_example(
    ...
    # print("Residue mask length: ", len(data["decoy"]["residue_mask"][0]), len(data["decoy"]["residue_mask"][1]))
    # print("Sequence length: ", len(data["decoy"]["sequence"][0]), len(data["decoy"]["sequence"][1]))
...
if __name__ == '__main__':
    ...
    for mode in structure_modes:
        ...
        for index, (id_value, id_R, id_L) in enumerate(zip(id_values, id_values_R, id_values_L)):
            ...
            # if len(missing_systems)> 0 and id_value in missing_systems:
    ...
    for files, dmodes in zip(pdb_paths, modes_decoy):
        ...
        print(count, "=======")
        print("Mode and Complex name: ", mode_r, complex_name)
        print("Receptor and Ligand paths: ", receptor_pdb, ligand_pdb)
        ...
        try:
            ...
            with open("/home/celine/geodock_inference_240124/errors_xl_pred_cpu.txt", "a") as file:

...
if __name__ == '__main__':
    ...
    for files, dmodes in zip(pdb_paths, modes_decoy):
        ...
        try:
            ...
            with open("/home/celine/geodock_inference_231213/pinder_af2/exception_log.txt", "a") as file:
